...
This sample will work only with RH SSO 7.5+ (Keycloak 15.0+). For older versions you must remove access token response transformation code (OIDCAccessTokenResponseMapper interface and transformAccessTokenResponse method)  